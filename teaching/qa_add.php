...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO qa (type,n_acc, n_title,n_news) VALUES (%s,%s, %s, %s)",
...
<table width="200" border="1" align="center" bordercolor="#FFFFFF">
  <tr>
	...
	<form id="form1" name="form1" method="POST" action="<?php echo $editFormAction; ?>" onsubmit="alert('新增完畢')">
   ...
   <div class="field field_v2">
    <label for="last-name" class="ha-screen-reader"> 類型</label>
	 ...
	 <input name="tp" type="radio" value="HTML"   />
	 HTML
	  <input name="tp" type="radio" value="CSS"    />
	  CSS
	   <input name="tp" type="radio" value="JavaScript"    />
	   JavaScript
  ...
  <div class="field field_v1">
    ...
    <input name="name" class="field__input" id="first-name" value="<?php echo $_SESSION['MM_Username']?>" placeholder="e.g. name">
    <span class="field__label-wrap" aria-hidden="true">
  ...
  <div class="field field_v3">
    ...
    <input name="qq" class="field__input" id="email" placeholder="e.g. question">
    <span class="field__label-wrap" aria-hidden="true">
      <span class="field__label">問題</span>
            ...
            <div align="center">
              <input name="送出" type="submit" value="送出"  style="width:120px;height:40px;"/>
